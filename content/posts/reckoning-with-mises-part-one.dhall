{ shortname = "reckoning-with-mises"
...
2. Late nineteenth and early twentieth century Marxist theorists had an interesting critiques of capitalist society, but no institutional blueprint to guide socialist construction. Austrian economists came along and pointed this embarassing fact out, at which point it fell to economists of a neoclassical bent and progressive sympathies (like Lange, Lerner, and Taylor) to fill in this gap. They showed, in varying ways, that the conceptual resources of neoclassical economics are not only useful for analyzing any society regardless of its characteristic forms of property, culture, etc. but can be drawn upon to devise planning institutions for socialism. Socialism was and remains entirely possible in principle. Economists cannot claim any special authority in evaluating its desirability. [^schumpterian]
...
When all production goods have a price in some common unit, anticipated marginal prices can be summed and compared with anticipated marginal revenues. If costs exceed revenues, the plan can be rejected immediately ("sure, we can make the body of the car out of titanium and be sure it won't rust, but it would triple the cost of the car and the number of buyers would plummet to basically zilch!"). Reckonings in terms of monetary cost do not uniquely determine a course of action for firm principals in contemporary capitalist society, but they do reduce the search space to a managable size. Without prices, socialist citizens would have no chance of producing "efficiently"[^efficiency].

Mises acknowledges socialist proposals to arrive at prices through an institutional arrangement free of rivalrous bidding by private owners (e.g. some sort of labor time accounting across the whole of society). He argues that reckoning costs in alternate, (non-monetary) units like labor hours would always be significantly arbitrary and that such prices would never adequately reflect shifting consumer and producer evaluations of productive possibilities (which he believed prices in contemporary capitalist socieities more or less did). Without the independent producer evaluations that private property makes possible, members of a socialist society would find it impossible to effectively coordinate their efforts to provision the goods and services necessary to live good lives.

## Up next

In the next few posts, I'll start walking through _Die Wirtschaftsrechnung..._ section by section to elaborate on the rough sketch given here.
